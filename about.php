          ...
          <div class='row'>
            <div class='col-sm-3'>
                <aside role='complementary'>
                    <ul>
                        <li ><a href='about.php' class = 'gray'>ABout  Overview</a></li>
                        <li ><a href='contact.php'>Contact Us</a></li>
                        <li><a href='request.php'>Request a Copier Quote</a></li>
                    </ul>
                    <div class='feature'>
                        <a href='contact.php'>
            ...
            <div class = 'col-sm-9'>
                ...
                <div class='row about_footer'>
                    <div class='col-sm-3 about_icon'>
                        <img src = 'images/template/about1.png'>
                        <p>
                            ".$row['service1']."
                        </p>
                    </div>
                    <div class='col-sm-3 about_icon'>
                        <img src = 'images/template/about2.png'>
                        <p>
                            ".$row['service2']."
                        </p>
                    </div>
                    <div class='col-sm-3 about_icon'>
                        <img src = 'images/template/about3.png'>
                        <p>
                            ".$row['service3']."
                        </p>
                    </div>
                    <div class='col-sm-3 about_icon'>
                        <img src = 'images/template/about4.png'>
                        <p>
                            ".$row['service4']."
                        </p>
                    </div>
