              ...
              <div class='col-sm-3'>
                  <aside role='complementary'>
                      <ul>
                          ...
                          <li class='selected'><a href='copies_printers.php'>Xerox Colour Multifunction Printers</a></li>
                ...
                <div class='col-sm-9'>
                  <h1>
                    Xerox Colour Multifunction Printers
                  </h1>
                    <div class='row products'>
                      <div class='col-sm-4 products_img'>
                        <img src = 'images/product/p1.png'>
                ...
                <div class='row products'>
                  ...
                  <div class='col-sm-8'>
                    ...
                    <ul>
                      ...
                      <li>
                        <strong>Small footprint:</strong> ".$row['p2_t2']."
                      </li>
                      <li>
                          <strong> Recommended Monthly Print Volume:</strong> ".$row['p2_t3']."
                      </li>
                      <li>
                          <strong>  Color: </strong> ".$row['p2_t4']."
                      </li>
                      <li>
                            <strong> Black:</strong> ".$row['p2_t5']."
                      </li>
                      <li>
                          <strong> Standard paper capacity: </strong> ".$row['p2_t6']."
                      </li>
                      <li>
                          <strong> Maximum paper capacity: </strong> ".$row['p2_t7']."
                      </li>
                    </ul>
                  </div>
              </div>
              ...
              <div class='row products'>
                ...
                <div class='col-sm-8'>
                  ...
                  <ul>
                    ...
                    <li>
                        <strong>Recommended Monthly Print Volume:</strong>   ".$row['p3_t6']."
                    </li>
                    <li>
                        <strong>  Color: </strong>   ".$row['p3_t7']."
                    </li>
                    <li>
                          <strong> Black:</strong>   ".$row['p3_t8']."
                    </li>
                    <li>
                        <strong> Maximum paper capacity: </strong>   ".$row['p3_t9']."
                    </li>
                    <li>
                        <strong> Standard paper capacity: </strong>   ".$row['p3_t10']."
                    </li>
        ...
        <div class = 'container'>
            <div class='row'>
                <div class='col-sm-3'>
                    ...
                    <ul class='omega'>
                          <li class='addr'>".$row['office_add']."</li>
