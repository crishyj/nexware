            ...
            <div class='row'>
              <div class='col-sm-3'>
                <aside role='complementary'>
                    <ul>
                        <li ><a href='qe.php' class = 'gray'>ERP Systems Overview</a></li>
                        <li ><a href='bp.php' class = 'left_logo'><img src = 'images/template/bp_bos.png' >Printing Business Software</a></li>
                        <li><a href='be.php' class = 'left_logo'><img src = 'images/template/be_bos.png' >ERP System for all SMEs</a></li>
                        <li class ='selected'><a href='pricing.php'>Pricing</a></li>
                    </ul>
                    <div class='feature'>
                            <a href='contact.php'>
                ...
                <div class='col-sm-9'>
                    <h1>
                        <center>  Pricing – Monthly Subscriptions </center>
                   </h1>
                   <h4><center>".$row['desc1']."</center></h4>
                   <ul class = 'qe_ul'>
                      <li>
                        <strong> Single License:</strong> ".$row['desc1_1']."
                      </li>
                      <li>
                        <strong> Multi License:</strong> ".$row['desc1_2']."
                      </li>
                   </ul>
                  ...
                  <ul class = 'qe_ul'>
                      <li>
                        <strong> Standard Rate: </strong> ".$row['desc3_1']."
                      </li>

                      <li>
                        <strong> Senior Rate: </strong> ".$row['desc3_2']."
                      </li>
                  </ul>
                  ...
                  <ul class = 'qe_ul'>
                    <li>
                      <a href = ''>BOSPrint Online Documentation</a>
                    </li>
                    <li>
                      <a href = ''>BOSEnterprise Online Documentation</a>
                    </li>
                  </ul>
                  ...
                  <ul class = 'qe_ul'>
                    ...
                    <li>
                      <strong>Company: </strong>".$row['t2']."
                    </li>

                    <li>
                      <strong>Customers/suppliers: </strong>".$row['t3']."
                    </li>

                    <li>
                      <strong>	Cost cernters: </strong>".$row['t4']."
                    </li>

                    <li>
                      <strong>	Materials: </strong>".$row['t5']."
                    </li>

                    <li>
                      <strong>	Services: </strong>".$row['t6']."
                    </li>

                    <li>
                      <strong>	Printing: </strong>".$row['t7']."
                    </li>

                    <li>
                      <strong>	Templates: </strong>".$row['t8']."
                    </li>

                    <li>
                      <strong>	History: </strong>".$row['t9']."
                    </li>
