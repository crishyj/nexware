      ...
      <?php
          ...
          if (isset($_POST['p'])) {
            if( checkToken( $_POST['csrf_token'], 'protectedForm' ) ) {
                ...
                $sql1 = "UPDATE supplies SET t1='$t1' WHERE id=1";
                $sql2 = "UPDATE supplies SET t2='$t2' WHERE id=1";
                $sql3 = "UPDATE supplies SET t3='$t3' WHERE id=1";
...
<?php
  ...
  $sql = "SELECT * FROM supplies ORDER BY id DESC LIMIT 1";
